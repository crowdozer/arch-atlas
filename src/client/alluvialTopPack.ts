 ...
 * 2. Right-truncate long node labels (full paths stay in title / aria), then
 *    re-anchor title chips with Carbon’s hang heuristic (full-width layout
 *    leaves a gap after truncate).
